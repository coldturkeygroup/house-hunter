...
Installing "House Hunter" can be done either by searching for "House Hunter" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
